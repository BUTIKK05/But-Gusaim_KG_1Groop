...
public class CoordinatePlaneVersion2Correct extends JPanel {
    ...
    public class SettingsPanel extends JPanel {
        public SettingsPanel() {
            ...
            timeLabel = new JLabel("Время выполнения: 0 мс");
            gbc.gridx = 0;
            gbc.gridy = 0;
            gbc.gridwidth = 2;
            ...
            btnBrasenham.addActionListener(e -> {
                try {
                    ...
                    updateTimeLabel(endTime - startTime);
                    repaint();
    ...
    public CoordinatePlaneVersion2Correct() {
    ...
    private void updateTimeLabel(long elapsedTime) {
        long elapsedMillis = elapsedTime / 1000000;
        SwingUtilities.invokeLater(() -> {
            timeLabel.setText("Время выполнения: " + elapsedMillis + " мс");
        });
    }
    ...
    public static void main(String[] args) {
        ...
        CoordinatePlaneVersion2Correct plane = new CoordinatePlaneVersion2Correct();
